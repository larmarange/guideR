...
- [`mean_sd()`](https://larmarange.github.io/guideR/reference/mean_sd.md)
...
- [`fisher.simulate.p()`](https://larmarange.github.io/guideR/reference/gtsummary_test.md)
  [`svyttest_oneway()`](https://larmarange.github.io/guideR/reference/gtsummary_test.md)
  :
...
- [`plot_proportions()`](https://larmarange.github.io/guideR/reference/plot_proportions.md)
  [`stratified_by()`](https://larmarange.github.io/guideR/reference/plot_proportions.md)
  [`dummy_proportions()`](https://larmarange.github.io/guideR/reference/plot_proportions.md)
...
- [`safe_pal()`](https://larmarange.github.io/guideR/reference/safe_pal.md)
  [`scale_fill_safe()`](https://larmarange.github.io/guideR/reference/safe_pal.md)
  [`scale_colour_safe()`](https://larmarange.github.io/guideR/reference/safe_pal.md)
  [`scale_color_safe()`](https://larmarange.github.io/guideR/reference/safe_pal.md)
...
- [`observed_vs_theoretical()`](https://larmarange.github.io/guideR/reference/observed_vs_theoretical.md)
  : Plot observed vs predicted distribution of a fitted model

- [`step_with_na()`](https://larmarange.github.io/guideR/reference/step_with_na.md)
  :
...
- [`tbl_maihda()`](https://larmarange.github.io/guideR/reference/tbl_maihda.md)
  ...
  [`get_strata_predictions()`](https://larmarange.github.io/guideR/reference/tbl_maihda.md)
  [`plot_strata_predictions()`](https://larmarange.github.io/guideR/reference/tbl_maihda.md)
  [`glance_maihda_model()`](https://larmarange.github.io/guideR/reference/tbl_maihda.md)
  **\[experimental\]** : Table summary of for MAIHDA analysis

## Classification tree

- [`plot_inertia_from_tree()`](https://larmarange.github.io/guideR/reference/plot_inertia_from_tree.md)
  [`get_inertia_from_tree()`](https://larmarange.github.io/guideR/reference/plot_inertia_from_tree.md)
  : Plot inertia, absolute loss and relative loss from a classification
  tree

## Logical operators

- [`is_different()`](https://larmarange.github.io/guideR/reference/is_different.md)
  [`is_equal()`](https://larmarange.github.io/guideR/reference/is_different.md)
  [`cumdifferent()`](https://larmarange.github.io/guideR/reference/is_different.md)
  [`num_cycle()`](https://larmarange.github.io/guideR/reference/is_different.md)
  :
...
- [`bold_variable_group_headers()`](https://larmarange.github.io/guideR/reference/gtsummary_utilities.md)
  ...
  [`add_glance_header()`](https://larmarange.github.io/guideR/reference/gtsummary_utilities.md)
  :
...
- [`titanic`](https://larmarange.github.io/guideR/reference/titanic.md)
